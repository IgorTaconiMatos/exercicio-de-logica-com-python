...
if opcao == 1:
    print(
        f"Pagando à vista no dinheiro ou no cheque você ganha um desconto de 10% totalizando o preço da compra em R${preco - (preco * 0.1):.2f}."
    )
# opção 2
elif opcao == 2:
    print(
        f"Pagando à vista no cartão você ganha um desconto de 5% totalizando o preço da compra em R${preco - (preco * 0.05):.2f}."
    )
# opção 3
elif opcao == 3:
...
9x ou 10x com 25% acréscimo"""
    ...
    if parcelas == 3 or parcelas == 4:
        ...
        print(
            f"Sua compra será parcelada em {parcelas}x de R${mes:.2f} com JUROS de 10%"
        )
        print(
            f"Sua compra de R${preco:.2f} vai custar R${mes * parcelas:.2f} no final."
        )
    # se 5 ou 6 parcelas
    elif parcelas == 5 or parcelas == 6:
        mes = (preco * 0.15 + preco) / parcelas
        print(
            f"Sua compra será parcelada em {parcelas}x de R${mes:.2f} com JUROS de 15%"
        )
        print(
            f"Sua compra de R${preco:.2f} vai custar R${mes * parcelas:.2f} no final."
        )
        ...
        print(
            f"Sua compra será parcelada em {parcelas}x de R${mes:.2f} com JUROS de 20%"
        )
        print(
            f"Sua compra de R${preco:.2f} vai custar R${mes * parcelas:.2f} no final."
        )
        ...
        print(
            f"Sua compra será parcelada em {parcelas}x de R${mes:.2f} com JUROS de 25%"
        )
        print(
            f"Sua compra de R${preco:.2f} vai custar R${mes * parcelas:.2f} no final."
        )
