...
bras = ('Internacional', 'Flamengo', 'Atlético-MG', 'Fluminese', 'São Paulo', 'Santos', 'Palmeiras', 'Grêmio', 'Sport', 'Fortaleza', 'Corinthians', 'Ceará', 'Atlético-GO', 'Botafogo', 'Bahia', 'Vasco', 'Coritiba', 'Bragantino', 'Athletico-PR', 'Goiás')
